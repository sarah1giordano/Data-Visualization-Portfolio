...
I created the following visual using Tableau to help visualize the extent to which Japan's national debt to GDP ratio is an outlier, even among countries with high debt to GDP ratios. The process I used to develop this visualization is documented below under **Process**.
